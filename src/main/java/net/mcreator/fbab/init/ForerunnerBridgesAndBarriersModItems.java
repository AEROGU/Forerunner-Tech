...
public class ForerunnerBridgesAndBarriersModItems {
	...
	public static final RegistryObject<Item> FLUID_BARRIER = block(ForerunnerBridgesAndBarriersModBlocks.FLUID_BARRIER,
			ForerunnerBridgesAndBarriersModTabs.TAB_FORERUNNER_TECH);
	public static final RegistryObject<Item> REDSTONE_WIRE_BLOCK = block(ForerunnerBridgesAndBarriersModBlocks.REDSTONE_WIRE_BLOCK,
			ForerunnerBridgesAndBarriersModTabs.TAB_FORERUNNER_TECH);
	...
	public static final RegistryObject<Item> LIGHT_WIRE = block(ForerunnerBridgesAndBarriersModBlocks.LIGHT_WIRE,
			ForerunnerBridgesAndBarriersModTabs.TAB_FORERUNNER_TECH);
	public static final RegistryObject<Item> REDSTONE_WIREON = block(ForerunnerBridgesAndBarriersModBlocks.REDSTONE_WIREON,
			ForerunnerBridgesAndBarriersModTabs.TAB_FORERUNNER_TECH);
